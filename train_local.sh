...
--adaptive_stddev=False --with_vtrace=False --max_policy_lag=100000000 --rnn_size=128 --kl_loss_coeff=0.1 \
...
--decoder_mlp_layers=256 \
--quads_num_agents=6 \
--quads_mode=mix --quads_episode_duration=18.0 \
--quads_obs_repr=xyz_vxyz_R_omega \
--quads_neighbor_hidden_size=128 --quads_neighbor_obs_type=pos_vel --quads_collision_hitbox_radius=1.7 \
...
--experiment=neuralfly_long_train_small_rnn \
