...
def add_quadrotors_env_args(env, parser):
    ...
    p.add_argument('--sim_freq', default=200, type=int, help="Simulation frequency")

    # Neighbor Features
    p.add_argument('--quads_neighbor_visible_num', default=-1, type=int, help='Number of neighbors to consider. -1=all '
                                                                              '0=blind agents, '
                                                                              '0<n<num_agents-1 = nonzero number of '
                                                                              'agents')
    ...
    # Room
    p.add_argument('--quads_room_dims', nargs='+', default=[5., 5., 2.], type=float,
    ...
    p.add_argument('--generate_quantization_samples', action='store_true', help="Generate samples for post training "
                                                                                "quantization")
